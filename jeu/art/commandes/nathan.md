# Nathan — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Roi d'Opale qui bascule de l'indifférence à l'engagement militaire et économique auprès des Chevaliers d'Émeraude.*
...
_Le texte ne décrit pas explicitement cette entité — inventer avec sobriété, dans l'esprit du reste._
...
`jeu/art/personnages/nathan.png` — fond transparent, PNG sans compression avec perte.
