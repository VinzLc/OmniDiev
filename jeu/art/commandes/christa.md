# Christa — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Sœur aînée de Wellan, devenue Reine de Fal par son mariage avec le Prince Patsko.*
...
`jeu/art/personnages/christa.png` — fond transparent, PNG sans compression avec perte.
