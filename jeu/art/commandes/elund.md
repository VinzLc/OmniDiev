# Élund — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Magicien du Château d'Émeraude chargé de la sélection et de l'entraînement des enfants aux pouvoirs exceptionnels, et de l'attribution des Écuyers aux Chevaliers.*
...
> « Élund ramassa les pans de sa tunique et de sa cape et s’assit devant le jeune Elfe. »
...
`jeu/art/personnages/elund.png` — fond transparent, PNG sans compression avec perte.
