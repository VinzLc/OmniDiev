# Mori — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Magicien de Béryl spécialisé dans l'interprétation des astres, connu pour ses présages et son savoir accumulé.*
...
`jeu/art/personnages/mori.png` — fond transparent, PNG sans compression avec perte.
