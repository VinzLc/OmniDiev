# Dempsey — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Fils du Roi Wyler et de la Reine Stela de Béryl, Dempsey est un Chevalier d'Émeraude qui devient un officier de confiance de Wellan.*
...
> « Dempsey était l’un des meilleurs pisteurs d’Enkidiev, mais au lieu de se fier a ses yeux et aux empreintes sur le sol, il s’en remit pluté6t a son ouie et a ses facultés magiques. »
...
`jeu/art/personnages/dempsey.png` — fond transparent, PNG sans compression avec perte.
