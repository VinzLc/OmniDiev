# Roi Lang — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Monarque du Royaume de Jade, père de Shenyann et mentor militaire de Dylan.*
...
> « Jeune et vigoureux, le Roi Lang portait ses cheveux noirs tressés sur la nuque et, imperturbable, les fixait de ses yeux bridés. »
>
> « Le Roi Lang portait un long vêtement de soie noire. »
...
`jeu/art/personnages/roi-lang.png` — fond transparent, PNG sans compression avec perte.
