# Mira — sprite de personnage

> À jouer après avoir posé [le contexte](../CONTEXTE.md) dans la session.

*Fiche Codex : Reine du royaume de Rubis et mère de Wellan, elle incarne une affection distante et des valeurs traditionnelles.*
...
> « Elle fit sauter sa fille sur ses genoux en admirant ses traits. »
>
> « Pour la première fois depuis qu’elle le connaissait, la Sholienne lut de l’admiration dans ses yeux bleus. »
...
`jeu/art/personnages/mira.png` — fond transparent, PNG sans compression avec perte.
